...
To ensure we can use your contributions, we require that you agree to a 
**Developer Certificate of Origin (DCO)**. This is the same mechanism used by 
the Linux Kernel project.

By signing off on your commits, you attest that you have the right to submit 
your code under the project's license.
