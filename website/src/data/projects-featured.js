...
const scanCodeToolkitProject = {
    ...
    documentation_url: 'https://scancode-toolkit.readthedocs.io/en/stable/',
...
export const featuredProjectSources = [
    {
        id: 'featured-row-1',
        data: [scanCodeIoProject, scanCodeToolkitProject],
    },
    {
        id: 'featured-row-2',
        data: [purlDBProject, dejaCodeProject, vulnerableCodeProject],
    },
    {
        id: 'featured-row-3',
        data: [packageUrlProject, clearlyDefinedProject],
    },
];
