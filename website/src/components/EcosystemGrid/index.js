...
const ecosystemAndLanguageItems = [
    ...
    { label: 'SWID', logo: 'img/logos/swid.svg', url: 'https://packageurl.org/docs/purl-spec/types-doc/swid-definition' },
    ...
    { label: 'C/C++', logo: 'img/logos/cpp.svg', url: 'https://isocpp.org' },
...
const vulnSources = [
    ...
    { label: 'EPSS', logo: 'img/logos/epss.svg', url: 'https://www.first.org/epss/', logoClass: 'logoLarge' },
    ...
    { label: 'NVD', logo: 'img/logos/nvd.svg', url: 'https://nvd.nist.gov', logoClass: 'logoLarge' },
    { label: 'OpenSSL', logo: 'img/logos/openssl.svg', url: 'https://www.openssl.org/news/vulnerabilities.html', logoClass: 'logoWideLarge' },
    ...
    { label: 'Vulnrichment (CISA)', logo: 'img/logos/cisa.svg', url: 'https://github.com/cisagov/vulnrichment', logoClass: 'logoLarge' },
