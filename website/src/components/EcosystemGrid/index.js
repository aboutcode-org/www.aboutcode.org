...
const programming_languages = [
    ...
    { label: 'Go', logo: 'img/logos/golang.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/golang-definition.md' },
    ...
    { label: 'Swift', logo: 'img/logos/swift.svg', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/swift-definition.md' },
...
const package_ecosystems = [
    ...
    { label: 'Bazel', logo: 'img/logos/bazel.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/bazel-definition.md' },
    { label: 'Bitbucket', logo: 'img/logos/bitbucket.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/bitbucket-definition.md' },
    { label: 'Bitnami', logo: 'img/logos/bitnami.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/bitnami-definition.md' },
    { label: 'Bower', logo: 'img/logos/bower.png', url: 'https://bower.io' },
    { label: 'Cargo', logo: 'img/logos/cargo.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/cargo-definition.md' },
    { label: 'Chef', logo: 'img/logos/chef.png', url: 'https://www.chef.io', logoClass: 'logoLarge' },
    { label: 'Chrome Extension', logo: 'img/logos/chrome.svg', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/chrome-extension-definition.md' },
    { label: 'CocoaPods', logo: 'img/logos/cocoapods.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/cocoapods-definition.md' },
    { label: 'Composer', logo: 'img/logos/composer.jpg', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/composer-definition.md' },
    { label: 'Conan', logo: 'img/logos/conan.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/conan-definition.md' },
    { label: 'Conda', logo: 'img/logos/conda.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/conda-definition.md' },
    { label: 'CPAN', logo: 'img/logos/cpan.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/cpan-definition.md', logoClass: 'logoLarge' },
    { label: 'CRAN', logo: 'img/logos/cran.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/cran-definition.md' },
    { label: 'Docker', logo: 'img/logos/docker.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/docker-definition.md' },
    { label: 'F-Droid', logo: 'img/logos/fdroid.png', url: 'https://f-droid.org' },
    { label: 'GitHub', logo: 'img/logos/github.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/github-definition.md' },
    { label: 'GitLab', logo: 'img/logos/gitlab.png', url: 'https://gitlab.com', logoClass: 'logoLarge' },
    { label: 'Hackage', logo: 'img/logos/hackage.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/hackage-definition.md' },
    { label: 'Hex', logo: 'img/logos/hex.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/hex-definition.md' },
    { label: 'Hugging Face', logo: 'img/logos/huggingface.svg', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/huggingface-definition.md' },
    { label: 'Julia', logo: 'img/logos/julia.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/julia-definition.md' },
    { label: 'LuaRocks', logo: 'img/logos/luarocks.svg', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/luarocks-definition.md' },
    { label: 'Maven', logo: 'img/logos/maven.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/maven-definition.md' },
    { label: 'MLflow', logo: 'img/logos/mlflow.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/mlflow-definition.md' },
    { label: 'npm', logo: 'img/logos/npm.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/npm-definition.md' },
    { label: 'NuGet', logo: 'img/logos/nuget.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/nuget-definition.md' },
    { label: 'OCI', logo: 'img/logos/oci.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/oci-definition.md' },
    { label: 'opam', logo: 'img/logos/opam.svg', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/opam-definition.md', logoClass: 'logoLarge' },
    { label: 'OTP', logo: 'img/logos/otp.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/otp-definition.md' },
    { label: 'Pub', logo: 'img/logos/pub.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/pub-definition.md' },
    { label: 'PyPI', logo: 'img/logos/pypi.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/pypi-definition.md' },
    { label: 'RPM', logo: 'img/logos/rpm.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/rpm-definition.md', logoClass: 'logoLarge' },
    { label: 'RubyGems', logo: 'img/logos/gem.png', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/gem-definition.md' },
    { label: 'VS Code Extension', logo: 'img/logos/vscode.svg', url: 'https://github.com/package-url/purl-spec/blob/main/docs/types/definitions/vscode-extension-definition.md' },
];
