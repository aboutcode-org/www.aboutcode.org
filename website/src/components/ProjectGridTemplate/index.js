    ...
    <div className={styles.projectGridWrapper01}>
      ...
      {projectSources.map((source, sourceIdx) => (
        <div key={sourceIdx} className={styles.gridSection}>
          ...
          <div className={styles.sectionIntro}>{source.description}</div>
                ...
                >
                  ...
                  <div>
                    <div className={styles.projectDescriptionWrapper}>
                      <DescriptionWithTooltip
                        text={project.description.map((para, idx) => (
                          <p key={idx}>{para}</p>
                        ))}
                      />
                    </div>
                  ...
                  <div className={styles.modalLinks01}>
                    {project.documentation_url &&
                      project.documentation_url !== "Not applicable" &&
                      project.documentation_url !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
                  ...
                  <div className={styles.modalLinks01}>
                    {project.repository_url &&
                      project.repository_url !== "Not applicable" &&
                      project.repository_url !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
                  ...
                  <div className={styles.modalLinks01}>
                    {project.service_url &&
                      project.service_url !== "Not applicable" &&
                      project.service_url !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
      ...
      {selectedProject && (
        <div className={styles.modalBackdrop} onClick={closeModal}>
          ...
          >
                ...
                <div className={styles.column}>
                  <div>
                    {selectedProject.repository_url &&
                      selectedProject.repository_url !== "Not applicable" &&
                      selectedProject.repository_url !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
                    ...
                    {packageDownloadUrls.length > 0 && (
                      <div className={styles.modalLinks01}>
                        ...
                        >
                          ...
                          {packageDownloadUrls.length > 1 ? "s" : ""}:{" "}
                        </span>
                        <ul className={styles.packageDownloadUrlList}>
                  ...
                  <div>
                    {selectedProject.documentation_url &&
                      selectedProject.documentation_url !== "Not applicable" &&
                      selectedProject.documentation_url !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
                  ...
                  <div>
                    {selectedProject.service_url &&
                      selectedProject.service_url !== "Not applicable" &&
                      selectedProject.service_url !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
                  ...
                  <div>
                    {selectedProject.languages &&
                      selectedProject.languages !== "Not applicable" &&
                      selectedProject.languages !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
                  ...
                  <div>
                    {selectedProject.platform &&
                      selectedProject.platform !== "Not applicable" &&
                      selectedProject.platform !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
                  ...
                  <div>
                    {selectedProject.software_license &&
                      selectedProject.software_license !== "Not applicable" &&
                      selectedProject.software_license !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
                  ...
                  <div>
                    {selectedProject.data_license &&
                      selectedProject.data_license !== "Not applicable" &&
                      selectedProject.data_license !== "Not available" && (
                        <div className={styles.modalLinks01}>
                          <span
                            style={{
                              fontWeight: "bold",
            ...
            {modalMessage && (
              <div className={styles.modalAlertOverlay}>{modalMessage}</div>
            )}
          </div>
        </div>
      )}
