                  ...
                  <h4 className={styles.projectName}>
                    {project.repository_url ? (
                      <a
                        ...
                        target={
                          project.repository_url.startsWith("http")
                            ? "_blank"
                            : "_self"
                        }
              ...
              <div>
                <div className={styles.packageDownloadWrapper}>
                  ...
                  {project.package_download_url &&
                    project.package_download_url.length > 0 && (
                      <ul
                        style={{
                          margin: 0,
                          paddingLeft: "1.5rem",
              ...
              <>
                ...
                <div className={styles.column}>
                  <div className={styles.modalLinks01}>
                    <span style={{ fontWeight: "bold" }}>Repository URL: </span>

                    {selectedProject.repository_url &&
                    selectedProject.repository_url !== "n/a" &&
                    selectedProject.repository_url !== "#" ? (
                      <a
                  ...
                  <div className={styles.modalLinks01}>
                    ...
                    selectedProject.documentation_url !== "n/a" &&
                    selectedProject.documentation_url !== "#" ? (
                      <a
                  ...
                  <div className={styles.modalLinks01}>
                    ...
                    {selectedProject.package_download_url &&
                      selectedProject.package_download_url.length > 0 && (
                        <ul
                          style={{
                            margin: 0,
                            paddingLeft: "1.5rem",
                  ...
                  <div className={styles.modalLinks01}>
                    <span style={{ fontWeight: "bold" }}>Service URL: </span>
